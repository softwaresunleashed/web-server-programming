...
%>
	...
	<td class=whitetext bgcolor ='#AAAAAA' align='center' colspan='2' >Applicant Name</th>
...
<input type='text' disabled='disabled' name='marks_gained' id='marks_gained' size= '5' value = '<%=applicantTestDtlDBObj.marks_gained%>' />
	...
	if( dbopr != null && ( dbopr.equals("shortlist_after_wrtn") || dbopr.equals("applicant_call_for_tech") || dbopr.equals("delete")) ){
	  ...
	  out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=applicant_call_for_tech&&applicant_id="+applicantTestDtlDBObj.applicant_id+"' class=yellowlink>Select For Tech </a>");
	  out.println("</td >");
	...
	{
	  out.println("<td align='center' bgcolor ='#AAAAAA'>");
	  out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=applicant_call_for_hr&&applicant_id="+applicantTestDtlDBObj.applicant_id+"' class=yellowlink>Select For HR </a>");
	  out.println("</td >");
	...
	{
	  out.println("<td align='center' bgcolor ='#AAAAAA'>");
	  out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=applicant_call_for_final&&applicant_id="+applicantTestDtlDBObj.applicant_id+"' class=yellowlink>Select For FInal </a>");
	  out.println("</td >");
	...
	{
	  out.println("<td align='center' bgcolor ='#AAAAAA'>");
	  out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=upd_wrtn_record&&applicantid="+applicantTestDtlDBObj.applicant_id+" ' class=yellowlink>Edit </a>");
	  out.println("</td >");
	}
	else  
	...
	{
	  out.println("<td align='center' bgcolor ='#AAAAAA'>");
	  out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=upd_tech_record&&applicantid="+applicantTestDtlDBObj.applicant_id+" ' class=yellowlink>Edit </a>");
	  out.println("</td >");
	}
	else  
	...
	{
	  out.println("<td align='center' bgcolor ='#AAAAAA'>");
	  out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=upd_hr_record&&applicantid="+applicantTestDtlDBObj.applicant_id+" ' class=yellowlink>Edit </a>");
	  out.println("</td >");
	}	     
  }
} 
...
{
out.println("<tr>");
out.println("<td class=whitetext bgcolor ='#AAAAAA' align='center' colspan='13'>The Selected Applicant</th>");
out.println("</tr>");
...
if( dbopr != null && ( dbopr.equals("shortlist_after_wrtn") || dbopr.equals("shortlist_after_tech") || dbopr.equals("applicant_call_for_tech") || dbopr.equals("delete") )){
	...
	out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=delete&&applicant_id="+applicantTestDtlDBObj.applicant_id+" ' class=yellowlink>Delete</a>");
	out.println("</td >");
}
else
if( dbopr != null && ( dbopr.equals("shortlist_after_tech") || dbopr.equals("applicant_call_for_hr") || dbopr.equals("discard") )){
	out.println("<td align='center' colspan='2' bgcolor ='#AAAAAA'>");
	out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=discard&&applicant_id="+applicantTestDtlDBObj.applicant_id+" ' class=yellowlink>Discard</a>");
	out.println("</td >");
}
else
if( dbopr != null && ( dbopr.equals("shortlist_after_hr") || dbopr.equals("discard_for_final") || dbopr.equals("applicant_call_for_final")  )){
	out.println("<td align='center' colspan='2' bgcolor ='#AAAAAA'>");
	out.println("<a href='http://localhost:8080/people-mgmt/servlet/applicant_test_dtl?dbopr=discard_for_final&&applicant_id="+applicantTestDtlDBObj.applicant_id+" ' class=yellowlink>Remove</a>");
	out.println("</td >");
	}
	out.println("</tr>");
}
