...
<form name="form1" method="post">
	...
	<tr><td>Phone</td>
	<td><input type='text' name='phone' id='phone' size ='15' maxLength="8" value='<%=applicantDBObj.phone%>'/></td>
	<td>Mobile</td><td><input type='text' name='mobile' id='mobile' size ='15' maxLength="10" value='<%=applicantDBObj.mobile%>'/></td>
	</tr>
	<tr>
	...
	<tr>
	<td bgcolor ='#AAAAAA' colspan='6' align=center height=20><b>Domain Knowledge</b></td>
	</tr>
	<tr><td>Domain</td>
