...
%>
	...
	<tr>
	<td bgcolor ='#AAAAAA' class=whitetext align=center height=20><b>Salary Heads Distribution</b></td>
	</tr>
...
<%
	...
	<td align='left'> <input type='hidden' name='agreement_date' id='agreement_date' size ='10' value='<%=employeeDBObj.dojoin%>'/>
	<input type='text' disabled='disabled' name='d_agreement_date' id='d_agreement_date' size ='10' value='<%=employeeDBObj.dojoin%>'/> (yyyy-mm-dd)</td></tr>
	<tr><td colspan=2>
	<table border=0>
		<tr>
...
%>
	...
	<a href='http://localhost:8080/people-mgmt/servlet/people_payroll?dbopr=edit_head&&emp_id=<%=employeeAgreement.emp_id%>&&allowance_name=<%=employeeAgreement.allowance_name%>' class=yellowlink>Edit</a>
	</td >
	<td align='center' bgcolor="#AAAAAA">
	<a href='http://localhost:8080/people-mgmt/servlet/people_payroll?dbopr=delete_head&&emp_id=<%=employeeAgreement.emp_id%>&&allowance_name=<%=employeeAgreement.allowance_name%>' class=yellowlink>Delete</a>
	</td >
	</tr>
	<% } %>
	</table>
