...
<table  border="0" align="top" width=100% >
  ...
  <tr>
	  <td>Org Id</td><input type='hidden' name='org_id' id='org_id' size ='10' value="KLSI"/>
  ...
  <tr>
	  ...
	  <td align='left' colspan='2'><input type='text' name='dojoin' id='dojoin' size ='10' value=''/>(yyyy-mm-dd)</td>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
  </tr>
  <tr>
...
<td> All the ( <sup>*</sup>) marked are mandatory</td></tr><tr>
	  ...
	  <input type='hidden' name='action_submit' id='action_submit' size ='10' value='people_employee_insert_submit'/>
	  </td>
  </tr>
</table>
<hr width=100% color=#AAAAAA>
