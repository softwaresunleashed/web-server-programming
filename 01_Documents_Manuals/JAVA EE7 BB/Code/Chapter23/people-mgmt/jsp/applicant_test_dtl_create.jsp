...
<table  border="0"  width=500 align=center>
  ...
  <tr>
  <td bgcolor ='#AAAAAA' colspan='4' align=center class=whitetext><b>Test Detail</b></td>
  </tr>
  <tr>
  <td >Test Id</td>
  ...
  <input type='hidden' name='action_submit' id='action_submit' size ='10' value='people_applicant_wrtn_test_dtl_submit'/>
  </td>
  </tr>
</table>
<hr width=500 color="#AAAAAA">
